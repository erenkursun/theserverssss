...
module.exports.run = async (client,message,args) => {
   if(!args[0]) return message.channel.send("Lütfen Bir Bot İd Gir!");
   ...
   .setDescription("**[Bota Oy Ver! "+b.username+"#"+b.discrim+" in WynexBots](https://website/bot/"+b.botID+"/vote)**")
